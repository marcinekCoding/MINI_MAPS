...
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|c|cccccccccc|c|c|}
\hline
\textbf{Trasa} & \textbf{Odległość [m]} & \textbf{P1 [s]} & \textbf{P2 [s]} & \textbf{P3 [s]} & \textbf{P4 [s]} & \textbf{P5 [s]} & \textbf{P6 [s]} & \textbf{P7 [s]} & \textbf{P8 [s]} & \textbf{P9 [s]} & \textbf{P10 [s]} & \textbf{Średni czas [s]} & \textbf{Błąd bezwzgl. [s]} \\
\hline
...
\hline
Billard -- Drzwi WRS MiNI & 38 & 29,57 & 28,81 & 26,95 & 29,28 & 28,46 & 29,27 & 31,13 & \textcolor{red}{26,83} & \textcolor{red}{32,46} & 30,82 & 29,29 & $\pm$2,93 \\
\hline
\end{tabular}%
}
\end{table}
