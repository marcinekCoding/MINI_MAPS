...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \caption*{(a) Główna klatka schodowa -- punkt odniesienia dla pomiarów ruchu pieszego.}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.48\textwidth}
        \centering
        ...
        \caption*{(b) Winda osobowa -- punkt pomiaru czasu przejazdu i narzutu wejścia/wyjścia.}
    \end{minipage}
\end{figure}
