...
\subsection*{2. O czym pisać (Wskazówki merytoryczne)}
\begin{itemize}
    \item \textbf{Wektor zapytania:} Konwersja profilu użytkownika na wektor zapytania $\vec{q} = [q_O, q_S, q_D]^T$ (np. profil „Cicha nauka” $\rightarrow \vec{q} = [0.1, 0.0, 0.1]^T$).
