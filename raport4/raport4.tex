...
\subsection*{3. Na czym się skupić (Kluczowe uwagi Pana Profesora)}
\begin{itemize}
    \item \textbf{Unikanie sztuczności:} Pan Profesor kładł nacisk na to, by deskryptory miały bezpośrednie odzwierciedlenie w fizycznych czujnikach. Każda składowa wektora musi mieć jasną interpretację poznawczą.
\end{itemize}
...
\subsection*{2. Na czym się skupić (Kluczowe uwagi Pana Profesora)}
\begin{itemize}
