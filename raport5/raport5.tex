...
\begin{itemize}
    ...
    \item \textbf{Testy z~45~studentami} --- stopa sukcesu $84\%$, średnia ocena $4.1/5$ (wówczas skala $1$--$10$, wartość $8.1$).
\end{itemize}
...
Eksperyment trwał w~okresie 28~maja--12~czerwca 2026~r. na terenie Wydziału MiNI~PW. Procedura obejmowała trzy fazy:

\paragraph{Faza~1 --- rekrutacja i onboarding (28~maja, dzień 0).}
\begin{enumerate}
...
\paragraph{Faza~2 --- dwutygodniowe użytkowanie (29~maja--11~czerwca, dni 1--14).}
...
\begin{itemize}
    ...
    \item ocenę warunków w~skali $1$--$5$,
...
\paragraph{Faza~3 --- ankieta końcowa (12~czerwca, dzień 15).}
...
\begin{itemize}
    ...
    \item \textbf{Średnia ocena $1$--$5$} --- średnia arytmetyczna ocen po sesjach (w~Etapie~4 stosowaliśmy skalę $1$--$10$; wartości z~Raportu~4 można porównać po przeskalowaniu $x_5 = x_{10}/2$).
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|c|}
        \hline
        \textbf{Profil} & \textbf{Sesje} & \textbf{Zadowoleni (Tak)} & \textbf{Średnia ocena 1--5} \\
        \hline
        Cicha nauka & 304 & 62\% (189) & 3.0 \\
        \hline
        Praca w~grupie & 243 & 81\% (197) & 3.6 \\
        \hline
        Relax & 165 & 94\% (155) & 4.1 \\
        \hline
        \textbf{Łącznie} & \textbf{712} & \textbf{76\% (541)} & \textbf{3.7} \\
        \hline
    \end{tabular}
    }
\end{table}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            height=6.5cm,
            bar width=22pt,
            ylabel={Średnia ocena (skala 1--5)},
            symbolic x coords={Cicha nauka, Praca w~grupie, Relax, Łącznie},
            xtick=data,
            ymin=0, ymax=5,
            nodes near coords,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Średnia ocena warunków w~sali w~podziale na profile (skala 1--5).}
    \label{fig:ocena_bar}
\end{figure}
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
        ...
        \hline
        3~profile użytkownika z~ankietą & Opóźnienie aktualizacji danych \\
        \hline
        Mechanizm Rocchio (feedback adaptacyjny) & Badanie ograniczone do Wydziału MiNI~PW \\
        \hline
        Brama mediany (ochrona przed nadużyciami) & Brak analizy widma dźwięku (mowa vs. szum) \\
        \hline
        Dynamiczna aktualizacja z~czujników & Aplikacja działa tylko lokalnie \\
        \hline
        2~eksperymenty ($125$ osób, 712~sesji) & Tylko 7~sal w~indeksie \\
        \hline
    \end{tabular}
    }
\end{table}
